...
useEffect(() => {
  if(products.length>0){
    ...
    setrelestedproducts(productCopy.slice(0,5))
  }
1 }, [products])
...
return product && (
        <div className="mt-12">
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        className="w-full py-3.5 cursor-pointer font-medium bg-gray-100 text-gray-800/80
          ...
          <div className='flex flex-col items-center mt-20' >
            ...
            }} className=' mx-auto cursor-pointer px-12 my-12 py-2.5 border rounded
