                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select onChange={e=>updatetocart(product._id,Number(e.target.value))} value={carditem[product._id]}
                                         className='outline-none'>
                                            {Array(carditem[product._id] > 9 ? carditem[product._id]:9).fill('').map((_, index) => (
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectAddress ? `${selectAddress.street},${selectAddress.city},${selectAddress.state}
                        ,${selectAddress.country}`:"NO Address Found"   }</p>
